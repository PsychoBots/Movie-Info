...
👨‍💻 **Developer :** [PsychoBots](https://github.com/PsychoBots)

📢 **Channel :** [Fayas Noushad](https://telegram.me/Psycho_Bots)

👥 **Group :** [Developer Team](https://telegram.me/PsychoBots_chat)
🌐 **Source :** [👉 Click here](https://github.com/Psycho_Bots/Movie-Info)
...
JOIN_BUTTONS = [
    InlineKeyboardButton(
        ...
        url='https://telegram.me/Psycho_Bots'
    )
]
